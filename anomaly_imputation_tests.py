...
plt.tight_layout()
plt.savefig("anomaly_score_curve_model_2.png", dpi=150)
plt.show()
...
plt.tight_layout()
plt.savefig("rmse_by_anomaly_decile_model_2.png", dpi=150)
plt.show()
...
plt.grid(True, alpha=0.4)
plt.tight_layout()
plt.savefig("imputation_sensitivity_curve_model_2.png", dpi=150)
plt.show()
